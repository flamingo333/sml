...
public class FrameworkConstant {
	...
	public static String PARAM_TOLOWERCASEFORKEY="toLowerCaseForKey",PARAM_SQLFORMAT="formatSql",PARAM_IGLOG="igLog",PARAM_QUERYTYPE="queryType",PARAM_FLUSHCACHE="FLUSHCACHE",PARAM_OPLINKS="opLinks",PARAM_ISREMOTEPRAMS="isRemoteParams",PARAM_FIELDFILTER="igFieldFilter";
